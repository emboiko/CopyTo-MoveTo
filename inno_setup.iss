[Setup]
AppId={{EA6C45FF-553E-45EE-8249-3C6B350A03EE}
...
OutputBaseFilename=Install CopyTo-MoveTo
...
Source: "C:\Programming\Python\Projects\CopyTo-MoveTo\dist\CopyTo-MoveTo\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Permissions:users-modify
...
[Run]
Filename: "{app}\CopyTo-MoveTo.exe"; Description: "{cm:LaunchProgram,CopyTo-MoveTo}"; Flags: nowait postinstall skipifsilent
